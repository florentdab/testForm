...
use TestFormBundle\Entity\Album;
...
class AlbumController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $albums = $em->getRepository('TestFormBundle:Album')->findAll();
    ...
    {
        $album = new Album();
        $form = $this->createForm('TestFormBundle\Form\AlbumType', $album);
    ...
    {
        $deleteForm = $this->createDeleteForm($album);
        $editForm = $this->createForm('TestFormBundle\Form\AlbumType', $album);
